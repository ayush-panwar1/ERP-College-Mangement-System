...
function StudentPortal() {
  ...
  async function handleGradeBtn() {
    setLoading(true);
    const response = await fetch(`${import.meta.env.VITE_API_URL}/student/gradereport`, {
      method: "GET",
      credentials: "include",
    });
  ...
  const getProfile = async () => {
    try {
      const response = await fetch(
        `${import.meta.env.VITE_API_URL}/student/studentprofile`,
        {
          method: "GET",
          credentials: "include",
        },
  ...
  async function handleGetFreeReceipt() {
    try {
      setLoading(true);
      const response = await fetch(`${import.meta.env.VITE_API_URL}/student/feereceipt`, {
        method: "GET",
        credentials: "include",
      });
      const data = await response.json();
