...
function Departments() {
  ...
  return (
    <>
      <div className="ps-2 pt-5 pe-2 w-100 d-none d-md-block">
        <h3
          className="text-center mb-2 fw-bold custom-heading text-wrap"
          style={{ color: "#0d47a1" }}
        >
        ...
        {visibleDepartments.map((e, i) => {
          ...
          return (
            <div
              key={i}
              className=" card mb-3 content-box"
              style={{
                maxWidth: "100%",
                maxHeight: "230px",
                overflow: "hidden",
